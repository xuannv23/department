    ...
    <div class="card-body">
        <form method="POST" action = "{{ route('departments.store') }} " enctype="multipart/form-data">
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-10"><input type="text" class="form-control" name="depart_loca"></div>
            </div>
            <div class="row mb-4">
                <label  class="col-sm-2 col-label-form">Leader ID</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10"><input type="text" class="form-control" name="since"></div>
            </div>
